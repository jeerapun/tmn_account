...
<div class="span9">
    ...
    <form class="well" action="TransferController" method="POST">
        <input name="code" type="hidden" value="<c:out value="${requestScope.code}"/>" />
        <label>Account</label>
        <input name="accountTransfer" type="text" class="span3" placeholder="0">
        <label>Amount</label>
        <input name="amount" type="text" class="span3" placeholder="0">
        <span class="help-block">Amount money to transfer</span>
